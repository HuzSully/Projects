...
class SVMModel:
    def __init__(self, random_state=None, **kwargs):
        """
        Initializes the SVMModel class with optional parameters.

        Parameters:
        - random_state: Seed for random number generation.
        - kwargs: Additional arguments to pass to the SVC model.
        """
        self.model = SVC(random_state=random_state, **kwargs)
    ...
    def predict_proba(self, X):
        ...
        Note: Only works if `probability=True` is set when initializing the model.
        ...
        if hasattr(self.model, "predict_proba"):
            ...
            raise AttributeError("Probability estimates are not available. Set `probability=True` when initializing the model.")
    ...
    def get_params(self):
        """
        Gets the parameters of the SVM model.
    ...
    def tune_hyperparameters(self, X, y, param_grid, cv=5, scoring='accuracy', n_jobs=-1):
        """
        Tunes the hyperparameters of the SVM model using GridSearchCV.
